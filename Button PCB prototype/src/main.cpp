 ...
 * @author  [Your Name]
 * @date    2025-12-21
 * @brief   MCP23017 Six-Chip Button Test
 *
 * @description
 * Reads button inputs from six MCP23017 I/O expanders over I2C.
 ...
 * - MCP23017 #5 at address 0x24: reads GPA6-GPA7
 * - MCP23017 #6 at address 0x25: reads GPA6-GPA7
 *
 * @hardware
 * - ESP32-S3-DevKitC-1
...
const int NUM_MCPS = 6;
const uint8_t MCP_ADDRESSES[] = {0x20, 0x21, 0x22, 0x23, 0x24, 0x25};
...
void setup() {
  Serial.begin(115200);
  delay(5000);
  Serial.println("MCP23017 Six-Chip Button Test");
